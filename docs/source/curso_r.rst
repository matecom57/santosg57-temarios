...
* 6. Funciones paralelizables 6.1 Apply, lapply y tapply.
...
* 9.1 Variables discretas y continuas

* 9.2 Distribuciones de Probabilidad

* 9.3 Análisis Exploratorio de Datos.(Estadística Descriptiva y Graficos)

* 9.4 Análisis de Varianza

* 10. Aplicaciones

* 10.1 Solución de Ecuaciones y Sistemas de Ecuaciones Lineales.

* 10.2 Solución de Ecuaciones Diferenciales Ordinarias

* 10.3 Análisis de Componentes Principales

* 10.4 Análisis de Agrupamiento (“Clustering”)

* 10.5 Análisis de Imágenes
